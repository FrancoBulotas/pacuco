...
const DataForMP = ({formData, currentData, handleInputChange, handleSubmit}) => {
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-50 rounded-xl p-4">
                    <label className="text-sm font-medium text-gray-600 mb-1 block">Usuario con datos cargados</label>
                    <div className="text-gray-900 font-medium">{currentData?.mercadoPago.currentUser}</div>
                </div>
            </div>
            </div>
