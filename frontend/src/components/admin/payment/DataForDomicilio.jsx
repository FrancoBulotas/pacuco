...
const DataForDomicilio = ({ formData, currentData, handleInputChange, handleSubmit }) => {
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-gray-50 rounded-xl p-4">
                        ...
                        <div className="text-gray-900 font-medium">$ {currentData?.priceShipmentDomicilio}</div>
                    </div>
                </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input
                            type="text"
                            value={formData.priceShipmentDomicilio}
                            onChange={(e) => handleInputChange("priceShipmentDomicilio", e.target.value)}
                            placeholder="Nuevo valor para envio domicilio"
...
export default DataForDomicilio;